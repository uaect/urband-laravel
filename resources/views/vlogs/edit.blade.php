...
@endsection
@section('content')
    @include('vlogs.partials.header', ['title' => __('Edit Vlog')])
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('vlogs.index') }}" class="btn btn-sm btn-primary"><span><i class="fas fa-arrow-left"></i></span>
                                    <span class="btn-inner--text">{{ __('Back to list') }}</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('vlogs.update', $vlogs) }}" autocomplete="off" enctype="multipart/form-data" id="vlogs-form">
                            @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title"
                                        ...
                                        placeholder="{{ __('Title') }}" value="{{ old('title', $vlogs->title) }}" required autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description"
                                        ...
                                        autofocus rows="10">{{ old('description', $vlogs->description) }}</textarea>
...
var uploadedDocumentMap = {}
  Dropzone.options.documentDropzone = {
    ...
    init: function () {
      ...
      @if(isset($vlogs) && $vlogs->vlogsImages)
        var files =
          {!! json_encode($vlogs->vlogsImages) !!}
        for (var i in files) {
          var file = files[i]
          myDropzone.options.addedfile.call(myDropzone, file);
          myDropzone.options.thumbnail.call(myDropzone, file, "/storage/" + file.image);
          file.previewElement.classList.add('dz-complete')
          $('#vlogs-form').append('<input type="hidden" name="document[]" value="' + file.image + '">')
        }
      @endif
    ...
    removedfile: function (file) {
      ...
      var _ref;
      $('#vlogs-form').append('<input type="hidden" name="delete_files[]" value="' + name + '">')
