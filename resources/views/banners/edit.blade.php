...
@section('content')
    @include('banners.partials.header', ['title' => __('Edit Banner')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('banner.index') }}" class="btn btn-sm btn-primary"><span><i class="fas fa-arrow-left"></i></span>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-name"
                                        ...
                                        placeholder="{{ __('Title') }}" value="{{ old('title', $banner->title) }}" required autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('sub_title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="sub_title" id="input-sub_title"
                                        ...
                                        placeholder="{{ __('Headline') }}" value="{{ old('sub_title', $banner->sub_title) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('page') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control js-example-basic-multiple form-control-alternative{{ $errors->has('page') ? ' is-invalid' : '' }}" name="page[]" multiple="multiple">
                                        ...
                                        $pages_data = json_decode($banner->page, true); ?>
                                        <option value="<?php echo $page; ?>" <?php if(in_array($page,$pages_data)) echo 'selected="selected"'; ?>><?php echo $page; ?></option>
                                        <?php } ?>
                                    </select>
                                    @if ($errors->has('page'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            ...
                            <?php if(@$banner) { ?>
                            <img src="<?php if(@$banner) {?>/storage/{{ @$banner->contentImage() }}<?php } ?>" id="preview" class="img-thumbnail">
                            <?php } ?>
                            </div>
                        </div>
                        <div class="row">
