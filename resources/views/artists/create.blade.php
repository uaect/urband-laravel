...
@endsection
@section('content')
@include('artists.partials.header', ['title' => __('Add Artist')])
    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('artist.store') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('genre') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="genre" id="input-genre"
                                        ...
                                        placeholder="{{ __('Genre') }}" value="{{ old('genre') }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('about') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="about"
                                        ...
                                        placeholder="{{ __('About') }}" autofocus rows="10">{{ old('about') }}</textarea>
