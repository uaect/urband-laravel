@extends('layouts.app', ['title' => __('Previous Shows')])
@section('pages_css')
...
@section('content')
@include('previous_shows.partials.header', ['title' => __('Previous Shows')])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Previous Shows') }}</h3>
                            @if (session('error'))
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('previous_shows.insert') }}" autocomplete="off" enctype="multipart/form-data" id="previous_shows">
                        @csrf
