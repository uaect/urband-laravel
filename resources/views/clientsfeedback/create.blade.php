...
@endsection
@section('content')
@include('clientsfeedback.partials.header', ['title' => __('Add Clients Feedback')])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Clients Feedback Management') }}</h3>
                            @if (session('error'))
                                <div class="alert alert-danger">{{session('error')}}</div>
                            @endif
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('clientfeedback.index') }}" class="btn btn-sm btn-primary"><span><i
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('clientfeedback.store') }}" autocomplete="off"
                        enctype="multipart/form-data">
                        @csrf

                        <h6 class="heading-small text-muted mb-4">{{ __('Clients Feedback information') }}</h6>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description"
                                        ...
                                        placeholder="{{ __('Feedback') }}" autofocus rows="10">{{ old('description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="file" name="image" class="file"
                                    accept="image/jpg,image/jpeg,image/JPG,image/JPEG,image/png,image/PNG">
