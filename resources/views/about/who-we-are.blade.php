...
@section('content')
@include('about.partials.header', ['title' => __('About Who We Are')])
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('About Who We Are') }}</h3>
                            @if (session('error'))
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('about.insert_about') }}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-name"
                                        ...
                                        placeholder="{{ __('Title') }}" value="{{ old('title',@$about->title) }}" required autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description"
                                        ...
                                        placeholder="{{ __('About Urband') }}" autofocus rows="10">{{ old('description',@$about->description) }}</textarea>
